...
단국대학교 주변 맛집 데이터를 기반으로 한 벡터 검색과 LLM을 활용한 지능형 식당 추천 시스템입니다.

## 📋 프로젝트 개요

- **목적**: 사용자의 자연어 입력을 기반으로 단국대 주변 맛집을 추천
- **기술 스택**: FAISS (벡터 DB), ko-sroberta-multitask, Qwen2.5-1.5B-Instruct, Streamlit
- **데이터**: 단국대 주변 15개 맛집의 750개 실제 리뷰 데이터
...
### 실전 프로젝트 경험
- **데이터 수집**: Selenium을 활용하여 네이버 식당 리뷰 데이터 크롤링
...
**개발자** : 정다훈, 오유석  
**목적**: 단국대학교 대학원 빅데이터 과목 프로젝트  
**기술 스택**: Python, FAISS, Transformers, Streamlit, CUDA  
**데이터**: 단국대 주변 15개 맛집, 750개 실제 리뷰  
